document.addEventListener("DOMContentLoaded", () => {
  ...
  sidebar.classList.add("sidebar", "closed"); // Sidebar cerrado por defecto
  ...
  // Ajustar el margen izquierdo del dashboard si el sidebar está cerrado
  if (dashboardRiver) {
      dashboardRiver.style.marginLeft = "1rem"; // Ajuste inicial para el margen izquierdo del dashboard cuando el sidebar está cerrado
  }
  ...
  toggleButton.addEventListener("click", () => {
      ...
      if (sidebar.classList.contains("closed")) {
          ...
          if (dashboardRiver) dashboardRiver.style.marginLeft = "1rem"; // Ajustar margen izquierdo del dashboard cuando está cerrado
      } else {
          sidebar.style.transform = "translateX(0)";
          toggleButton.style.left = "250px";
          if (dashboardRiver) dashboardRiver.style.marginLeft = "250px"; // Ajustar margen izquierdo del dashboard cuando está abierto
      }
  });
});
